...
public class Controller {
    ...
    @FXML
    Line introTocompro;
    @FXML Line comproTojava;
    @FXML Line comproTodataStruc;
    @FXML CubicCurve comproToppl;
    @FXML
    CubicCurve comproTodb;
    @FXML Line dataStrucToalgo;
...
//    SubjectTest project = new SubjectTest("01418490","Computer Science Project","01418390");
    ...
    public void initialize() {
        ...
        dataStruc.setVisible(false);
        db.setVisible(false);
        ppl.setVisible(false);
        introTocompro.setVisible(false);
        comproTojava.setVisible(false);
...
//        line2.setVisible(false);
    ...
    @FXML
    public void handleIntroComButtonClick(ActionEvent actionEvent) {
        comPro.setVisible(true);
        introTocompro.setVisible(true);
